...
public partial class BankContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC2748787EF1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC27F4882509");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC271D23E51F");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.BankTransactions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BankTrans__Accou__6A30C649");

            entity.HasOne(d => d.TransactionTypeNavigation).WithMany(p => p.BankTransactions)
                .HasForeignKey(d => d.TransactionType)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BankTrans__Trans__6B24EA82");
        });

        modelBuilder.Entity<Client>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC277B0EB0CE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transati__3214EC270E9379E6");
